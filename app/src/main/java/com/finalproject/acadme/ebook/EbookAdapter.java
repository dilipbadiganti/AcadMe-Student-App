package com.finalproject.acadme.ebook;
...
public class EbookAdapter extends RecyclerView.Adapter<EbookAdapter.EbookViewHolder> {
    ...
    public void onBindViewHolder(@NonNull EbookAdapter.EbookViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> Toast.makeText(context,list.get(position).getPdfTitle(),Toast.LENGTH_SHORT).show());
